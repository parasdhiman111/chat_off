...
import 'package:chatoff/pages/home_page.dart';
import 'package:chatoff/pages/login_page.dart';
import 'package:chatoff/pages/otp_page.dart';
...
abstract class LoginStoreBase with Store {
  ...
  Future<void> onAuthenticationSuccessful(BuildContext context, AuthResult result) async {
    ...
    Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => HomePage(cameras: cameras)), (Route<dynamic> route) => false);
